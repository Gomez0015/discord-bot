...
client.on('guildMemberAdd', member => {
    member.guild.channels.cache.get('769280253268459520').send(member.nickname + " Welcome to the sever! Read" + member.guild.channels.cache.find(channel => channel.name === "please-read-first").toString() + "to verify."); 
